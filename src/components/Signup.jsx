...
const Signup = () => {
    ...
    const signup = async () => {
        ...
        try {
            ...
            const userResponse = await axios.post('http://localhost:8084/api/user/signup', user);
            ...
            if (user.role === "AUTHOR") {
                ...
                try {
                    ...
                    const authorResponse = await axios.post('http://localhost:8084/api/author/register', authorPayload);
