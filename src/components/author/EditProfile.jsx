...
const EditProfile = () => {
    ...
    const upload = async () => {
        ...
        try {
            const response = await axios.post("http://localhost:8084/api/author/upload/profile-pic", formData,
                {
                    headers:
    ...
    useEffect(() => {
        const getAuthor = async () => {
            try {
                const response = await axios.get("http://localhost:8084/api/author/get", {
